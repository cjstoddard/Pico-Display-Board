...
sub bme280_init
local i%,cal%(17)
i2c2 open 400,1000 '400KHz bus speed
...
'
i2c2 write BME280_ADDRESS,0,2,BME280_REGISTER_CONTROLHUMID,&H05 '16x oversampling humidity
i2c2 write BME280_ADDRESS,0,2,BME280_REGISTER_CONTROL,&HB7 '16x oversampling pressure/temp, normal mode
'
end sub
'
